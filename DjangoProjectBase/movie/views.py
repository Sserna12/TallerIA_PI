...
def recommendations(request):
    ...
    if prompt:
        ...
        # Generar el embedding del prompt ingresado por el usuario
        ...
        # Comparar el prompt con todas las películas
        for movie in Movie.objects.all():
            ...
            similarity = np.dot(
                ...
                * np.linalg.norm(movie_embedding)
            )
        ...
        if recommended_movie:
            similarity_value = f"{max_similarity:.4f}"
